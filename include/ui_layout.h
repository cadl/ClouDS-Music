...
enum {
    ...
    UI_SETTINGS_LID_LR_SKIP_Y = 172,
    UI_SETTINGS_LID_LR_SKIP_HEIGHT = 24,
    UI_SETTINGS_CLEAR_Y = 198,
    UI_SETTINGS_CLEAR_HEIGHT = 28,
    UI_SETTINGS_CONTACT_Y = 228,
    UI_SETTINGS_CONTACT_HEIGHT = 62,
    UI_SETTINGS_REPOSITORY_Y = 292,
    UI_SETTINGS_REPOSITORY_HEIGHT = 62,
    UI_SETTINGS_USAGE_NOTICE_Y = 356,
    UI_SETTINGS_USAGE_NOTICE_HEIGHT = 28,
    UI_SETTINGS_VERSION_Y = 386,
